...
namespace PicklesDoc.Pickles.Test
{
    public class BaseFixture
    {
        ...
        protected IContainer Container
        {
            get
            {
                if (this.container == null)
                {
                    ...
                    var configuration = new Configuration() { ExcludeTags = "exclude-tag", TechnicalTags = "technicalTag1;technicalTag2" };
        ...
        protected void AddFakeFolderStructures()
        {
            ...
            this.AddFakeFolderAndFiles("FeatureCrawlerTests", new[] { "index.md", "LevelOne.feature", "image.png", "LevelOneIgnoredFeature.feature", "LevelOneRemoveTechnicalTag.feature" });
